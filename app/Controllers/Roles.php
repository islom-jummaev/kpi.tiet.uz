...
class roles extends Security_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['can_indicator_list'] = get_array_value($permissions, "can_indicator_list");
            $view_data['can_indicator_add_edit_delete'] = get_array_value($permissions, "can_indicator_add_edit_delete");
            $view_data['can_send_reports_view'] = get_array_value($permissions, "can_send_reports_view");
            $view_data['can_send_reports_approved'] = get_array_value($permissions, "can_send_reports_approved");
    ...
    function save_permissions() {
        ...
        $can_indicator_list = $this->request->getPost('can_indicator_list');
        $can_indicator_add_edit_delete = $this->request->getPost('can_indicator_add_edit_delete');
        $can_send_reports_view = $this->request->getPost('can_send_reports_view');
        $can_send_reports_approved = $this->request->getPost('can_send_reports_approved');
        ...
        $permissions = array(
            ...
            "can_indicator_list" => $can_indicator_list,
            "can_indicator_add_edit_delete" => $can_indicator_add_edit_delete,
            "can_send_reports_view" => $can_send_reports_view,
            "can_send_reports_approved" => $can_send_reports_approved
        );
