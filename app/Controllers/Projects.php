...
class Projects extends Security_Controller {
    ...
    function task_modal_form() {
        ...
        $view_data["projects_members_dropdown"] = $this->get_team_members_dropdown();
    ...
    function save_task() {
        ...
        if ($save_id) {
            ...
            if ($id) {
                ...
                //created
                // log_notification("project_task_created", array("project_id" => $project_id, "task_id" => $save_id), $this->login_user->id);
