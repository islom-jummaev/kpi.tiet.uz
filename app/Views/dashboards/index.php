<div id="page-content" class="page-wrapper clearfix">
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <?php if ($show_projects_count || $show_indicators_ball || $show_clock_status || $show_total_hours_worked || $show_total_project_hours) { ?>
                <div class="row">
                    <div class="col-md-12 mb20 text-center">
                        <div class="bg-white project_and_clock_status_widget">
                            ...
                            if ($show_indicators_ball) {
                                echo count_indicator_widget($login_user->id);
                            }
                ...
                <div class="col-md-12 widget-container">
                    <div class="card bg-white">
                        <div class="card-header">
                            <i data-feather="file-text" class="icon-16"></i>&nbsp;  <?php echo lang("incs.reports"); ?>
                        </div>
                        <div id="reporter-timeline-container">
                            <div class="card-body">
                                <?php
                                    echo activity_logs_widget_reports();
                                ?>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        initScrollbar('#reporter-timeline-container', {
            setHeight: 500
        });
