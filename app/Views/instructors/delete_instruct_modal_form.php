<?php echo form_open(get_uri("instructors/deleteInstructor"), array("id" => "instructors-instruct-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#instructors-instruct-form").appForm({
