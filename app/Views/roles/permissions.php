    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="permission-list">
                ...
                <li>
                    <span data-feather="key" class="icon-14 ml-20"></span>
                    <h5><?php echo lang("incs.set_indicator_permissions"); ?>:</h5>
                    <div>
                        <?php
                        echo form_checkbox("can_indicator_list", "1", $can_indicator_list ? true : false, "id='can_indicator_list' class='manage_project_section form-check-input'");
                        ?>
                        <label for="can_indicator_list"><?php echo lang("incs.can_indicator_list"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_indicator_add_edit_delete", "1", $can_indicator_add_edit_delete ? true : false, "id='can_indicator_add_edit_delete' class='manage_project_section form-check-input'");
                        ?>
                        <label for="can_indicator_add_edit_delete"><?php echo lang("incs.can_indicator_add_edit_delete"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_send_reports_view", "1", $can_send_reports_view ? true : false, "id='can_send_reports_view' class='manage_project_section form-check-input'");
                        ?>
                        <label for="can_send_reports_view"><?php echo lang("incs.can_send_reports_view"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_send_reports_approved", "1", $can_send_reports_approved ? true : false, "id='can_send_reports_approved' class='manage_project_section form-check-input'");
                        ?>
                        <label for="can_send_reports_approved"><?php echo lang("incs.can_send_reports_approved"); ?></label>
                    </div>
                </li>
                <li>
                    <span data-feather="key" class="icon-14 ml-20"></span>
