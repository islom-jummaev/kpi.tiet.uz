...
if (!function_exists('report_status')) {
    function report_status($status): string {
        if ($status == 1) return "<span class='badge bg-warning'>".lang("incs.pending")."</span>";
        if ($status == 2) return "<span class='badge bg-success'>".lang("incs.approved")."</span>";
        if ($status == 3) return "<span class='badge bg-danger'>".lang("incs.failure")."</span>";
